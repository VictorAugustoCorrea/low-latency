...
#ifndef LOWLATENCYSYSTEM_TCP_SOCKET_H
#define LOWLATENCYSYSTEM_TCP_SOCKET_H
...
namespace Common
{
    ...
    struct TCPSocket
    {
        ...
        auto defaultRecvCallBack(const TCPSocket *socket, const Nanos rx_time) noexcept
        {
        ...
        auto send(const void * data, const size_t len) noexcept
        {
            if (len > 0)
            {
...
#endif //LOWLATENCYSYSTEM_TCP_SOCKET_H